...
static unsigned long sqlctx = 40739;
...
36,0,0,2,38,0,5,32,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
59,0,0,3,0,0,30,37,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "update dept  set loc=:b0 where loc=:b1";
